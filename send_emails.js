...
const { createReadStream, mkdirSync, appendFileSync, existsSync } = require('fs');
...
async function main() {
    ...
    if (stats.skipped === total) {
        console.log('\n💡 Tip: Add an "email" column to your outreach CSV to enable sending.');
    }
}
